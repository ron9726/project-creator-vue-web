...
function init(initPath) {
  try {
    ...
    const alphaImportUrl = 'http://git.dqalpha.com/frontend/components/web/importer_vue_web.git';
    const alphaImportPath = './src/components/import';
    ...
    addSubmodule(initPath, alphaImportUrl, alphaImportPath);
